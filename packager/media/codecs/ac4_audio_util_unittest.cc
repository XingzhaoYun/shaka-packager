...
TEST(AC4AudioUtilTest, ChannelTest1) {
  ...
  const std::vector<uint8_t> ac4_data = {0x20, 0xa6, 0x02, 0x40, 0x00, 0x00, 0x00, 0x1f,
                                         0xff, 0xff, 0xff, 0xe0, 0x02, 0x12, 0xf8, 0x80,
                                         0x00, 0x00, 0x42, 0x00, 0x00, 0x02, 0x50, 0x10};
  ...
  EXPECT_TRUE(CalculateAC4ChannelConfigMpegSchemeValue(ac4_data, channel_config_mpeg_value));
